...
{ 
  ...
  // Creating ntuple
  // 默认 ntupleId 从0开始加，如果只维护一个ntuple，可以省略ID
  analysisManager->CreateNtuple("myB1", "Edep"); // name, title
  analysisManager->CreateNtupleIColumn("Event_ID"); //I型，先尝试全局维护一个Ntuple吧
